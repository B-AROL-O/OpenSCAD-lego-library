...
cn_lego_drill_large = 5.9+0.4;
cn_lego_height_beam = 7.8;

cn_lego_width_beam = 7.3; 
cn_lego_drill_axel = 2.0+0.1;
...
module plus( in_height = cn_lego_height_beam )
{
    union()
	{
        translate([-cn_lego_drill_axel/2, -cn_lego_drill_small/2, 0]) 
            cube([cn_lego_drill_axel, cn_lego_drill_small, in_height]);

        translate([-cn_lego_drill_small/2, -cn_lego_drill_axel/2, 0]) 
            cube([cn_lego_drill_small, cn_lego_drill_axel, in_height]);
    }
}
